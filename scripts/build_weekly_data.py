...
# collect selected IDs for W23: 2026-06-02 ~ 2026-06-08
...
with open('data/tmp/weekly_w23_data.json', 'w', encoding='utf-8') as f:
    json.dump(selected, f, ensure_ascii=False, indent=2)

print(f'Wrote {len(selected)} items to data/tmp/weekly_w23_data.json')
